          ...
          <form>
            <div class="form-row align-items-center">
              <div class="col-sm-12 my-1">
                <label class="sr-only" for="content">Email content  </label>
                <textarea
                  id="content"
                  class="form-control"
...
export default {
  data() {
    return {
      sent_on: this.$page.props.email ? this.$page.props.email.sent_on : new Date(),
      send_date_choice: this.$page.props.updateDisabled ? 1 : 2,
      content: this.$page.props.email ? this.$page.props.email.message : null,
    };
  },
  methods: {
    save: function () {
  ...
  mounted(){
      ...
      $('#content').summernote('pasteHTML', this.content);
