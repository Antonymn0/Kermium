              ...
              <div class="col-sm-4 my-1">
                ...
                <div class="input-group">
                  ...
                  <select
                    ...
                    @change="search()"
                  >
                    <option value="0">Any status events</option>
                    <option value="complete">Complete events only</option>
                    <option value="pending">Pending events only</option>
                    <option value="ongoing">Ongoing events only</option>
  ...
  methods: {
    search: function () {
      axios({
        ...
        .then((response) => {
          this.$page.props.latestEvents = response.data.data;
        })
        .catch((error) => {
          console.log(error);
        });
