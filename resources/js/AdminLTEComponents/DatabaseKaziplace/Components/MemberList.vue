<template>
  <div class="row mb-4">
    <div class="col-md-12">
      <div v-if="$page.props.databaseKaziplace" class="card">
          ...
          <div class="table-responsive resp-table">
            <table class="table table-striped mb-0">
              ...
              <tbody>
                ...
                <tr v-for="(member, index) in $page.props.databaseKaziplace.data"
              :key="index">
      ...
      <div v-else class="card">
        <div class="card-header border-transparent">
          <h3 class="card-title">No Member found in Kazi Place database. </h3>
        </div>
      </div>
    </div>
  </div>
  ...
  data: function(){
      ...
      methods:{
        ...
        bulkChangeState:function( status, memberIDs ){
          ...
          axios({
            method: "POST",
            url: "/v1/kaziplace/bulk-change-state",
            data: {
              status: status,
              memberIDs: memberIDs,
            },
